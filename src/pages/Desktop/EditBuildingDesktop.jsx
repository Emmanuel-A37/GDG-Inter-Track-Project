...
const EditBuildingDesktop = ({ buildingId, screenSize = 'desktop', onBack }) => {
      ...
      <div className="px-5 py-6 flex justify-center">
        <div className="w-full space-y-4" style={{ maxWidth: sizes.contentWidth }}>
          ...
          <ImageUpload
            ...
            containerSize="w-[1400px] h-[242px]"
            previewSize="w-[1368px] h-[162px]"
          />
...
export default EditBuildingDesktop;
